            ...
            <div className="row mx-3">
                ...
                <div className="col-md-8 d-flex align-items-center">
                    <ul className="nav">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link textoPrimario fs-4 bordeNav" activeclassname="active" to={"/category/fitness"}></NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link textoPrimario fs-4 bordeNav" activeclassname="active" to={"/category/musculacion"}></NavLink>
                        </li>
                    </ul>
                </div>
