                ...
                <div className="row">
                    <div className="col text-center">
                        <table className="table">
                            <tbody>
                                <tr>
                                    <td className="text-end align-middle" colSpan={6}><a href="#" onClick={clear} className="btn fondoNegro textoPrimario">Vaciar Carrito <img src="" alt="Eliminar Producto" title="Eliminar Producto" height={30}/></a></td>
                                </tr>
                                {cart.map(product =>
                                    <tr key={product.id}>
                                        ...
                                        <td className="text-end align-middle"><a href="#" onClick={() => {removeItem(product.id)}}><img src="" alt="Eliminar Producto" title="Eliminar Producto" height={30} /></a></td>
                                    </tr>
                                )}
                                <tr>
